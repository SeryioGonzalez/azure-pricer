...
numOfCustomerInputParams=11
conversionRate=0.82

firstColumnCalculations=firstColumnCustomerInput + numOfCustomerInputParams

#GET RESOURCE PRICES
computePriceMatrix = priceReaderCompute.getPriceMatrix()
siteRecoveryPriceMatrix = priceReaderSiteRecovery.getPriceMatrix()
premiumDiskPriceMatrix = priceReaderPremiumDisk.getPriceMatrix()
standardDiskPriceMatrix = priceReaderStandardDisk.getPriceMatrix()
...
#FORMULAS
formulaTotalComputeCost="=B5*SUM(X1:X"+str(rowsForVMInput+1)+")"
formulaTotalDiskCost="=B5*12*SUM(AR1:AR16)"
formulaTotalASRCost ="=B5*12*SUM(AO1:AO"+str(rowsForVMInput+1)+")*'azure-asr-prices'!A2"
formulaTotalCost="=SUM(B9:B11)"

#CHECKING ASR
formulaCheckASRPattern="=IF(AND(K{0}=\"YES\", N{0}=\"YES\"),1,\"\")"

#COUNTING DISKS
formulaCountS4Disk ="=SUM(Y1:Y"+str(rowsForVMInput+1)+")"
formulaCountS6Disk ="=SUM(Z1:Z"+str(rowsForVMInput+1)+")"
formulaCountS10Disk="=SUM(AA1:AA"+str(rowsForVMInput+1)+")"
formulaCountS15Disk="=SUM(AB1:AB"+str(rowsForVMInput+1)+")"
formulaCountS20Disk="=SUM(AC1:AC"+str(rowsForVMInput+1)+")"
formulaCountS30Disk="=SUM(AD1:AD"+str(rowsForVMInput+1)+")"
formulaCountS40Disk="=SUM(AE1:AE"+str(rowsForVMInput+1)+")"
formulaCountS50Disk="=SUM(AF1:AF"+str(rowsForVMInput+1)+")"
formulaCountP4Disk ="=SUM(AG1:AG"+str(rowsForVMInput+1)+")"
formulaCountP6Disk ="=SUM(AH1:AH"+str(rowsForVMInput+1)+")"
formulaCountP10Disk="=SUM(AI1:AI"+str(rowsForVMInput+1)+")"
formulaCountP15Disk="=SUM(AJ1:AJ"+str(rowsForVMInput+1)+")"
formulaCountP20Disk="=SUM(AK1:AK"+str(rowsForVMInput+1)+")"
formulaCountP30Disk="=SUM(AL1:AL"+str(rowsForVMInput+1)+")"
formulaCountP40Disk="=SUM(AM1:AM"+str(rowsForVMInput+1)+")"
formulaCountP50Disk="=SUM(AN1:AN"+str(rowsForVMInput+1)+")"
#PRICING DISKS
formulaPriceS4Disk ="=AQ1*'azure-standard-disk-prices'!C2"
formulaPriceS6Disk ="=AQ2*'azure-standard-disk-prices'!C3"
formulaPriceS10Disk="=AQ3*'azure-standard-disk-prices'!C4"
formulaPriceS15Disk="=AQ4*'azure-standard-disk-prices'!C5"
formulaPriceS20Disk="=AQ5*'azure-standard-disk-prices'!C6"
formulaPriceS30Disk="=AQ6*'azure-standard-disk-prices'!C7"
formulaPriceS40Disk="=AQ7*'azure-standard-disk-prices'!C8"
formulaPriceS50Disk="=AQ8*'azure-standard-disk-prices'!C9"
formulaPriceP4Disk ="=AQ9*'azure-premium-disk-prices'!C2"
formulaPriceP6Disk ="=AQ10*'azure-premium-disk-prices'!C3"
formulaPriceP10Disk="=AQ11*'azure-premium-disk-prices'!C4"
formulaPriceP15Disk="=AQ12*'azure-premium-disk-prices'!C5"
formulaPriceP20Disk="=AQ13*'azure-premium-disk-prices'!C6"
formulaPriceP30Disk="=AQ14*'azure-premium-disk-prices'!C7"
formulaPriceP40Disk="=AQ15*'azure-premium-disk-prices'!C8"
formulaPriceP50Disk="=AQ16*'azure-premium-disk-prices'!C9"

#CHECK ALL INPUT
formulaCheckAllInputsPattern="=IF(AND(D{0}<>\"\", E{0}<>\"\", F{0}<>\"\", G{0}<>\"\", H{0}<>\"\", I{0}<>\"\", J{0}<>\"\", K{0}<>\"\", L{0}<>\"\", M{0}<>\"\"),\"YES\",\"NO\")"

#VIRTUAL MACHINE FORMULAS
formulaVMBaseNamePattern    ="=IF(N{1}=\"YES\",VLOOKUP("+alphabet[firstColumnCalculations + 1]+"{1} & I{1} & J{1},'azure-vm-prices-base'!G$2:H${0}, 2, 0),\"\")"
formulaVMBaseMinPricePattern="=IF(N{1}=\"YES\", IF(M{1}=\"YES\" ,   _xlfn.MINIFS('azure-vm-prices-base'!C$2:C${0},  'azure-vm-prices-base'!A$2:A${0},\">=\"&E{1}*(100-B3)/100,  'azure-vm-prices-base'!B$2:B${0},\">=\"&F{1}*(100-B3)/100,  'azure-vm-prices-base'!D$2:D${0},I{1},  'azure-vm-prices-base'!E$2:E${0},J{1}), _xlfn.MINIFS('azure-vm-prices-base'!I$2:I${0},  'azure-vm-prices-base'!A$2:A${0},\">=\"&E{1}*(100-B3)/100,  'azure-vm-prices-base'!B$2:B${0},\">=\"&F{1}*(100-B3)/100,  'azure-vm-prices-base'!D$2:D${0},I{1},  'azure-vm-prices-base'!E$2:E${0},J{1})),\"\")"

formulaVM1YNamePattern      ="=IF(N{1}=\"YES\",VLOOKUP("+alphabet[firstColumnCalculations + 3]+"{1} & I{1} & J{1},'azure-vm-prices-1Y'!G$2:H${0}, 2, 0),\"\")"
formulaVM1YMinPricePattern  ="=IF(N{1}=\"YES\", IF(M{1}=\"YES\" ,   _xlfn.MINIFS('azure-vm-prices-1Y'!C$2:C${0},  'azure-vm-prices-1Y'!A$2:A${0},\">=\"&E{1}*(100-B3)/100,  'azure-vm-prices-1Y'!B$2:B${0},\">=\"&F{1}*(100-B3)/100,  'azure-vm-prices-1Y'!D$2:D${0},I{1},  'azure-vm-prices-1Y'!E$2:E${0},J{1}), _xlfn.MINIFS('azure-vm-prices-1Y'!I$2:I${0},  'azure-vm-prices-1Y'!A$2:A${0},\">=\"&E{1}*(100-B3)/100,  'azure-vm-prices-1Y'!B$2:B${0},\">=\"&F{1}*(100-B3)/100,  'azure-vm-prices-1Y'!D$2:D${0},I{1},  'azure-vm-prices-1Y'!E$2:E${0},J{1})),\"\")"
formulaVM3YNamePattern      ="=IF(N{1}=\"YES\",VLOOKUP("+alphabet[firstColumnCalculations + 5]+"{1} & I{1} & J{1},'azure-vm-prices-3Y'!G$2:H${0}, 2, 0),\"\")"
formulaVM3YMinPricePattern  ="=IF(N{1}=\"YES\", IF(M{1}=\"YES\" ,   _xlfn.MINIFS('azure-vm-prices-3Y'!C$2:C${0},  'azure-vm-prices-3Y'!A$2:A${0},\">=\"&E{1}*(100-B3)/100,  'azure-vm-prices-3Y'!B$2:B${0},\">=\"&F{1}*(100-B3)/100,  'azure-vm-prices-3Y'!D$2:D${0},I{1},  'azure-vm-prices-3Y'!E$2:E${0},J{1}), _xlfn.MINIFS('azure-vm-prices-3Y'!I$2:I${0},  'azure-vm-prices-3Y'!A$2:A${0},\">=\"&E{1}*(100-B3)/100,  'azure-vm-prices-3Y'!B$2:B${0},\">=\"&F{1}*(100-B3)/100,  'azure-vm-prices-3Y'!D$2:D${0},I{1},  'azure-vm-prices-3Y'!E$2:E${0},J{1})),\"\")"
formulaVMYearPAYGPattern="=IF(N{0}=\"YES\",L{0}*P{0}*12,\"\")"
formulaVMYear1YRIPattern="=IF(N{0}=\"YES\",R{0}*8760,\"\")"
formulaVMYear3YRIPattern="=IF(N{0}=\"YES\",T{0}*8760,\"\")"
formulaBestPricePattern ="=IF(N{0}=\"YES\",IF($B$4=\"YES\", MIN(U{0}:W{0}), U{0}),\"\")"

#STANDARD DISK FORMULAS
formulaDiskS4Pattern="=IF(AND(H{0}=\"STANDARD\",N{0}=\"YES\",G{0}<'azure-standard-disk-prices'!B2),1+IF(K{0}=\"YES\",1),\"\")"
formulaDiskS6Pattern="=IF(AND(H{0}=\"STANDARD\",N{0}=\"YES\",G{0}>'azure-standard-disk-prices'!B2,G{0}<'azure-standard-disk-prices'!B3),1+IF(K{0}=\"YES\",1),\"\")"
formulaDiskS10Pattern="=IF(AND(H{0}=\"STANDARD\",N{0}=\"YES\",G{0}>'azure-standard-disk-prices'!B3,G{0}<'azure-standard-disk-prices'!B4),1+IF(K{0}=\"YES\",1),\"\")"
formulaDiskS15Pattern="=IF(AND(H{0}=\"STANDARD\",N{0}=\"YES\",G{0}>'azure-standard-disk-prices'!B4,G{0}<'azure-standard-disk-prices'!B5),1+IF(K{0}=\"YES\",1),\"\")"
formulaDiskS20Pattern="=IF(AND(H{0}=\"STANDARD\",N{0}=\"YES\",G{0}>'azure-standard-disk-prices'!B5,G{0}<'azure-standard-disk-prices'!B6),1+IF(K{0}=\"YES\",1),\"\")"
formulaDiskS30Pattern="=IF(AND(H{0}=\"STANDARD\",N{0}=\"YES\",G{0}>'azure-standard-disk-prices'!B6,G{0}<'azure-standard-disk-prices'!B7),1+IF(K{0}=\"YES\",1),\"\")"
formulaDiskS40Pattern="=IF(AND(H{0}=\"STANDARD\",N{0}=\"YES\",G{0}>'azure-standard-disk-prices'!B7,G{0}<'azure-standard-disk-prices'!B8),1+IF(K{0}=\"YES\",1),\"\")"
formulaDiskS50Pattern="=IF(AND(H{0}=\"STANDARD\",N{0}=\"YES\",G{0}>'azure-standard-disk-prices'!B8,G{0}<'azure-standard-disk-prices'!B9),1+IF(K{0}=\"YES\",1),\"\")"
#PREMIUM DISK FORMULAS
formulaDiskP4Pattern="=IF(AND(H{0}=\"PREMIUM\",N{0}=\"YES\",G{0}<'azure-premium-disk-prices'!B2),1+IF(K{0}=\"YES\",1),\"\")"
formulaDiskP6Pattern="=IF(AND(H{0}=\"PREMIUM\",N{0}=\"YES\",G{0}>'azure-premium-disk-prices'!B2,G{0}<'azure-premium-disk-prices'!B3),1+IF(K{0}=\"YES\",1),\"\")"
formulaDiskP10Pattern="=IF(AND(H{0}=\"PREMIUM\",N{0}=\"YES\",G{0}>'azure-premium-disk-prices'!B3,G{0}<'azure-premium-disk-prices'!B4),1+IF(K{0}=\"YES\",1),\"\")"
formulaDiskP15Pattern="=IF(AND(H{0}=\"PREMIUM\",N{0}=\"YES\",G{0}>'azure-premium-disk-prices'!B4,G{0}<'azure-premium-disk-prices'!B5),1+IF(K{0}=\"YES\",1),\"\")"
formulaDiskP20Pattern="=IF(AND(H{0}=\"PREMIUM\",N{0}=\"YES\",G{0}>'azure-premium-disk-prices'!B5,G{0}<'azure-premium-disk-prices'!B6),1+IF(K{0}=\"YES\",1),\"\")"
formulaDiskP30Pattern="=IF(AND(H{0}=\"PREMIUM\",N{0}=\"YES\",G{0}>'azure-premium-disk-prices'!B6,G{0}<'azure-premium-disk-prices'!B7),1+IF(K{0}=\"YES\",1),\"\")"
formulaDiskP40Pattern="=IF(AND(H{0}=\"PREMIUM\",N{0}=\"YES\",G{0}>'azure-premium-disk-prices'!B7,G{0}<'azure-premium-disk-prices'!B8),1+IF(K{0}=\"YES\",1),\"\")"
formulaDiskP50Pattern="=IF(AND(H{0}=\"PREMIUM\",N{0}=\"YES\",G{0}>'azure-premium-disk-prices'!B8,G{0}<'azure-premium-disk-prices'!B9),1+IF(K{0}=\"YES\",1),\"\")"
...
customerVMDataExcelTab.conditional_format('N1:N'+str(rowsForVMInput+1), {'type':     'cell',
                                    'criteria': 'equal to',
                                    'value':    '\"YES\"',
                                    'format':   dataOKFormat})
...
customerVMDataExcelTab.set_column(0, 0, 20)  
...
for index in range(0, len(diskSizes)):
	customerVMDataExcelTab.write(index, 41 , diskSizes[index], selecHeader)
#COUNT DISKS
customerVMDataExcelTab.write_formula(0,  42, formulaCountS4Disk, selecBody)
customerVMDataExcelTab.write_formula(1,  42, formulaCountS6Disk, selecBody)	
customerVMDataExcelTab.write_formula(2,  42, formulaCountS10Disk, selecBody)	
customerVMDataExcelTab.write_formula(3,  42, formulaCountS15Disk, selecBody)	
customerVMDataExcelTab.write_formula(4,  42, formulaCountS20Disk, selecBody)	
customerVMDataExcelTab.write_formula(5,  42, formulaCountS30Disk, selecBody)	
customerVMDataExcelTab.write_formula(6,  42, formulaCountS40Disk, selecBody)	
customerVMDataExcelTab.write_formula(7,  42, formulaCountS50Disk, selecBody)
customerVMDataExcelTab.write_formula(8,  42, formulaCountP4Disk, selecBody)
customerVMDataExcelTab.write_formula(9,  42, formulaCountP6Disk, selecBody)	
customerVMDataExcelTab.write_formula(10, 42, formulaCountP10Disk, selecBody)	
customerVMDataExcelTab.write_formula(11, 42, formulaCountP15Disk, selecBody)	
customerVMDataExcelTab.write_formula(12, 42, formulaCountP20Disk, selecBody)	
customerVMDataExcelTab.write_formula(13, 42, formulaCountP30Disk, selecBody)	
customerVMDataExcelTab.write_formula(14, 42, formulaCountP40Disk, selecBody)	
customerVMDataExcelTab.write_formula(15, 42, formulaCountP50Disk, selecBody)		 
#PRICE DISKS
customerVMDataExcelTab.write_formula(0,  43, formulaPriceS4Disk, selecBody)
customerVMDataExcelTab.write_formula(1,  43, formulaPriceS6Disk, selecBody)	
customerVMDataExcelTab.write_formula(2,  43, formulaPriceS10Disk, selecBody)	
customerVMDataExcelTab.write_formula(3,  43, formulaPriceS15Disk, selecBody)	
customerVMDataExcelTab.write_formula(4,  43, formulaPriceS20Disk, selecBody)	
customerVMDataExcelTab.write_formula(5,  43, formulaPriceS30Disk, selecBody)	
customerVMDataExcelTab.write_formula(6,  43, formulaPriceS40Disk, selecBody)	
customerVMDataExcelTab.write_formula(7,  43, formulaPriceS50Disk, selecBody)
customerVMDataExcelTab.write_formula(8,  43, formulaPriceP4Disk, selecBody)
customerVMDataExcelTab.write_formula(9,  43, formulaPriceP6Disk, selecBody)	
customerVMDataExcelTab.write_formula(10, 43, formulaPriceP10Disk, selecBody)	
customerVMDataExcelTab.write_formula(11, 43, formulaPriceP15Disk, selecBody)	
customerVMDataExcelTab.write_formula(12, 43, formulaPriceP20Disk, selecBody)	
customerVMDataExcelTab.write_formula(13, 43, formulaPriceP30Disk, selecBody)	
customerVMDataExcelTab.write_formula(14, 43, formulaPriceP40Disk, selecBody)	
customerVMDataExcelTab.write_formula(15, 43, formulaPriceP50Disk, selecBody)
	
#HEADERS - DATA FROM CUSTOMER
customerVMDataExcelTab.write(0, firstColumnCustomerInput,   'VM NAME', inputHeader)
customerVMDataExcelTab.set_column(firstColumnCustomerInput, firstColumnCustomerInput, 20) 
 
customerVMDataExcelTab.write(0, firstColumnCustomerInput + 1, 'CPUs', inputHeader)
customerVMDataExcelTab.set_column(firstColumnCustomerInput+ 1, firstColumnCustomerInput+ 1, 5)  

customerVMDataExcelTab.write(0, firstColumnCustomerInput + 2, 'Mem(GB)', inputHeader)
customerVMDataExcelTab.set_column(firstColumnCustomerInput+ 2, firstColumnCustomerInput+ 2, 9)  

customerVMDataExcelTab.write(0, firstColumnCustomerInput + 3, 'STORAGE', inputHeader)
customerVMDataExcelTab.set_column(firstColumnCustomerInput+ 3, firstColumnCustomerInput+ 3, 9)  

customerVMDataExcelTab.write(0, firstColumnCustomerInput + 4, 'STORAGE TYPE', inputHeader)
customerVMDataExcelTab.set_column(firstColumnCustomerInput+ 4, firstColumnCustomerInput+ 4, 14)  
customerVMDataExcelTab.data_validation('J2:J'+str(rowsForVMInput), {'validate': 'list','source': ['STANDARD', 'PREMIUM']})

customerVMDataExcelTab.set_column(firstColumnCustomerInput+ 5, firstColumnCustomerInput+ 6, 5)  
customerVMDataExcelTab.write(0, firstColumnCustomerInput + 5, 'SAP', inputHeader)
customerVMDataExcelTab.data_validation('I2:I'+str(rowsForVMInput), {'validate': 'list','source': ['YES', 'NO']})

customerVMDataExcelTab.write(0, firstColumnCustomerInput + 6, 'GPU', inputHeader)
customerVMDataExcelTab.data_validation('J2:J'+str(rowsForVMInput), {'validate': 'list','source': ['YES', 'NO']})

customerVMDataExcelTab.write(0, firstColumnCustomerInput + 7, 'ASR', inputHeader)
customerVMDataExcelTab.set_column(firstColumnCustomerInput+ 7, firstColumnCustomerInput+ 7, 5)  
customerVMDataExcelTab.data_validation('K2:K'+str(rowsForVMInput), {'validate': 'list','source': ['YES', 'NO']})

customerVMDataExcelTab.write(0, firstColumnCustomerInput + 8, 'HOURS/MONTH', inputHeader)
customerVMDataExcelTab.set_column(firstColumnCustomerInput+ 8, firstColumnCustomerInput+ 8, 15)  
customerVMDataExcelTab.data_validation('L2:L'+str(rowsForVMInput), {'validate': 'list','source': ['730', '264']})

customerVMDataExcelTab.write(0, firstColumnCustomerInput + 9, 'USE B SERIES', inputHeader)
customerVMDataExcelTab.set_column(firstColumnCustomerInput+ 9, firstColumnCustomerInput+ 9, 12)  
customerVMDataExcelTab.data_validation('M2:M'+str(rowsForVMInput), {'validate': 'list','source': ['YES', 'NO']})

customerVMDataExcelTab.write(0, firstColumnCustomerInput + 10, 'ALL DATA OK', inputHeader)
customerVMDataExcelTab.set_column(firstColumnCustomerInput+ 10, firstColumnCustomerInput+ 10, 12) 

#HEADERS - CALCULATIONS
customerVMDataExcelTab.write(0, firstColumnCalculations + 0, 'BEST SIZE PAYG', selecHeader)
customerVMDataExcelTab.set_column(firstColumnCalculations + 0, firstColumnCalculations + 0, 14)   
customerVMDataExcelTab.write(0, firstColumnCalculations + 1, 'PRICE(H) PAYG', selecHeader)
customerVMDataExcelTab.set_column(firstColumnCalculations + 1, firstColumnCalculations + 1, 13) 
customerVMDataExcelTab.write(0, firstColumnCalculations + 2, 'BEST SIZE 1Y', selecHeader)
customerVMDataExcelTab.set_column(firstColumnCalculations + 2, firstColumnCalculations + 2, 12)   
customerVMDataExcelTab.write(0, firstColumnCalculations + 3, 'PRICE(H) 1Y', selecHeader)
customerVMDataExcelTab.set_column(firstColumnCalculations + 3, firstColumnCalculations + 3, 12) 
customerVMDataExcelTab.write(0, firstColumnCalculations + 4, 'BEST SIZE 3Y', selecHeader)
customerVMDataExcelTab.set_column(firstColumnCalculations + 4, firstColumnCalculations + 4, 12)   
customerVMDataExcelTab.write(0, firstColumnCalculations + 5, 'PRICE(H) 3Y', selecHeader)
customerVMDataExcelTab.set_column(firstColumnCalculations + 5, firstColumnCalculations + 5, 12) 
customerVMDataExcelTab.write(0, firstColumnCalculations + 6, 'YEAR PAYG', selecHeader)
customerVMDataExcelTab.set_column(firstColumnCalculations + 6, firstColumnCalculations + 6, 12) 
customerVMDataExcelTab.write(0, firstColumnCalculations + 7, '1Y RI', selecHeader)
customerVMDataExcelTab.set_column(firstColumnCalculations + 7, firstColumnCalculations + 7, 12)
customerVMDataExcelTab.write(0, firstColumnCalculations + 8, '3Y RI', selecHeader)
customerVMDataExcelTab.set_column(firstColumnCalculations + 8, firstColumnCalculations + 8, 12) 
customerVMDataExcelTab.write(0, firstColumnCalculations + 9, 'BEST PRICE', selecHeader)
customerVMDataExcelTab.set_column(firstColumnCalculations + 9, firstColumnCalculations + 9, 15) 

#PUT HEADERS FOR MANAGED DISKS
firsColumnDiskData = firstColumnCalculations + 10
customerVMDataExcelTab.set_column(firsColumnDiskData, firsColumnDiskData + len(diskSizes) - 1, 11) 
for index in range(0, len(diskSizes)):
	customerVMDataExcelTab.write(0, firsColumnDiskData + index, 'M. DISK - '+diskSizes[index], selecHeader)

customerVMDataExcelTab.write(0, firstColumnCalculations + 26, 'HAS ASR', selecHeader)
customerVMDataExcelTab.set_column(firstColumnCalculations + 26, firstColumnCalculations + 9, 8) 
...
#PUT DEFAULT VALUES
for rowIndex in range(1,rowsForVMInput):
#PUT ALL STORAGE TYPE TO STANDARD
	customerVMDataExcelTab.write(rowIndex, firstColumnCustomerInput +  4, 'STANDARD', inputBody)	
#PUT ALL SAP VMs TO NO
	customerVMDataExcelTab.write(rowIndex, firstColumnCustomerInput +  5, 'NO', inputBody)
...
#PUT ALL MONTHLY HOURS TO 730
	customerVMDataExcelTab.write_number(rowIndex, firstColumnCustomerInput +  8, 730, inputBody)
#PUT ALL BURSTABLE VMs TO NO
	customerVMDataExcelTab.write(rowIndex, firstColumnCustomerInput +  9, "NO", inputBody)
